        ...
        public bool Authenticate(uint myUniqueId, SteamClient client, string myLoginKey) {
            ...
            using (dynamic userAuth = WebAPI.GetInterface("ISteamUserAuth", null)) {
                ...
                try {
                    ...
                    string encrypted_loginkey = HttpUtility.UrlEncode(cryptedLoginKey);
                    args.Add("steamid", client.SteamID.ConvertToUInt64().ToString());
                    ...
                    authResult = userAuth.Call("AuthenticateUser", 1, args, WebRequestMethods.Http.Post, true);
